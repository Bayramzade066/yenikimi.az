        ...
        <div className="w-full h-full relative">
          <div className="w-full h-full flex justify-between items-center">
            <div className="category-and-nav flex xl:space-x-7 space-x-3 items-center ">
              <div className="category group w-[270px] h-[53px] bg-qblack text-white px-5 rounded-t-md mt-[6px] relative transition-all duration-500 hover:duration-500 hover:transition-all hover:bg-[#fec820]">
                <button
                  onClick={handler}
                  type="button"
                  ...
                  <div className="flex space-x-3 items-center text-qyellow group-hover:text-qblacktext">
                    <span>
                      <svg
                        ...
                        height="9"
                        viewBox="0 0 14 9"
                        className="text-qyellow group-hover:text-qblacktext"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <rect width="14" height="1" className="!text-qyellow group-hover:!text-qblacktext" />
                        <rect y="8" width="14" height="1" className="!text-qyellow group-hover:!text-qblacktext" />
                        <rect y="4" width="10" height="1" className="!text-qyellow group-hover:!text-qblacktext" />
                      </svg>
                    </span>
                ...
                >
                  <ul className="categories-list">
                    {CategoryApi && CategoryApi.data.map(category => (
              ...
              <div className="nav">
                <ul className="nav-wrapper flex xl:space-x-10 space-x-5">
                  <li>
                    <a href="/">
                                    <span className=" text-sm text-qblacktext font-600 cursor-pointer  hover:text-qgray">
                                      Ana Səhifə
                                    </span>
                                  </a>
                                  </li>
                  ...
                  <li>
                    <a href="/about">
                      <span className="flex items-center  text-sm text-qblacktext font-600 cursor-pointer hover:border-qyellow hover:text-qgray">
                        <span>Haqqında</span>
                      </span>
                    </a>
                  </li>
            ...
            <div className="become-seller-btn">
              <Link to="/become-saller">
                <div className="black-btn rounded-md w-[161px] h-[40px] flex justify-center items-center cursor-pointer">
                  <div className="flex space-x-2 items-center">
                    <span className="text-sm text-qyellow font-600">Satıcı olmaq</span>
                    <span>
                      <svg
                        width="6"
                        height="10"
