          ...
          <div className="main-wrapper w-full lg:flex lg:space-x-[30px]">
            <div className="lg:w-1/2 w-full">
              ...
              <p className="text-[15px] text-qgraytwo leading-[30px] mb-5">
                Aşağıdaki məlumatlardan bizimlə əlaqə saxlıya bilər həmçinin sizinlə əlaqəyə keçə bilməyimiz üçün öz məlumatlarınızı doldura bilərsiniz.
              </p>
              ...
              <div className="xl:flex xl:space-x-[30px] mb-[30px]">
                ...
                <div className="xl:w-1/2 w-full h-[196px] flex flex-col item justify-center bg-[#D3EFFF] p-5">
                  ...
                  <span className="w-full border-1 py-1 border-t border-gray-600"></span>
                  <span className="text-center text-sm text-gray-800 font-bold">Texniki yardım</span>
                  <p className="text-[15px] text-black leading-[30px] text-center">
                    bayramzade.313@gmai.com
                  </p>
                </div>
              </div>
              <div className="p-5 flex flex-col justify-between w-full bg-[#E7F2EC]">
                ...
                <iframe
                 title="newWork"
                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d97424.54134087966!2d50.265212701403314!3d40.264266158418685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307d6bd6211cf9%3A0x343f6b5e7ae56c6b!2sBaku%2C%20Azerbaijan!5e0!3m2!1sen!2sbd!4v1682576971655!5m2!1sen!2sbd"
