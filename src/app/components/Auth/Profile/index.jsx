...
export default function Profile() {
  ...
  data.append('email_or_phone', userData?.email);

    let config = {
      method: 'patch',
      maxBodyLength: Infinity,
      url: 'https://yenikimi.store/api/users/logout',
      headers: {
            'Content-Language': 'az',
          },
      data : data
                  ...
                  <div className="flex flex-col space-y-10">
                    <div className="item group">
                      <Link to="/profile#dashboard">
                        <div className="flex space-x-3 items-center transition-all duration-300 text-qgray hover:text-qyellow">
                          <span>
                            <IcoDashboard />
                          </span>
                    ...
                    <div className="item group"> 
                        ...
                        <div onClick={refreshCode} className="cursor-pointer flex space-x-3 items-center transition-all duration-300 text-qgray hover:text-qyellow" >
                          <span>
                            <IcoLogout />
                          </span>
                          <span className=" font-normal text-base">
