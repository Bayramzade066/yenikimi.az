...
import { login, LoginRegisterData, LoginVerifyData, register, resendVerifyCode, verifyUser } from "../../../services/Users";
                            ...
                            <div className="w-full">
                                ...
                                <div className="input-area">
                                    ...
                                    >
                                        ...
                                        {responseError && <span className={`text-center ${responseError == 'Yeni təsdiq kodu göndərildi' ? 'text-qyellow' : 'text-red-600'} `}>{responseError}</span>}
                                            <div className="flex justify-center pt-2">
                                                ...
                                                >
                                                    <span >{success ? <Spin className="text-qyellow" /> : 'Təsdiqlə'}</span>
                                                </button>
                                                {/* </a> */}
                                            </div>
                                    ...
                                    <div className="signup-area flex justify-center">
                                        <p className="text-base text-qgraytwo font-normal cursor-pointer">
                                            Kod almadınız ? {counter == 0 ? <span onClick={refreshCode} className="text-qyellow">Yenidən kod göndərin </span> : <span className="text-qyellow">00 : {counter < 10 && <span>0</span>}{counter}</span>}
