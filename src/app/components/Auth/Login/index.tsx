                ...
                <div className="input-area">
                  ...
                  <span className="cursor-pointer font-semibold text-base text-qyellow hover:text-qblack" onClick={()=> setLoginChoose(!loginChoose)}>Mail ilə daxil ol</span>
                    ...
                    <div className="forgot-password-area flex justify-between items-center ">
                      ...
                      <a
                        ...
                        className="text-base text-qyellow hover:text-qblack"
                      >
                        Şifrəmi unutmuşam
                      </a>
                    </div>
                    ...
                    {responseError && <span className="text-center text-red-600">{responseError} :(</span>}
                      <div className="flex justify-center pt-2">
                        {/* <a className="w-full h-full" href={`/`}> */}
                          ...
                          >
                            <span >{success ? <Spin className="text-qyellow" /> : 'Daxil ol'}</span>
                          </button>
                        {/* </a> */}
                      </div>
                      <a
                      ...
                      >
                        ...
                        <span className="text-[18px] text-qgraytwo font-normal">
                          Google hesabınız ilə daxil olun
                        </span>
                      </a>
                    </div>
                  </Form>
                  <div className="signup-area flex justify-center">
                    <p className="text-base text-qgraytwo font-normal">
                      ...
                      <a
                        href="/signup"
                        className="ml-2 text-qyellow hover:text-blue-600 transition-all hover:transition-all"
                      >
                        qeydiyyatdan keçin
                      </a>
                    </p>
